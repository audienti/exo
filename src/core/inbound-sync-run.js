  ...
  const accounts = payload.accounts.map((accountInput) => {
    ...
    const surfaces = accountInput.surfaces.map((surfaceInput) => {
      ...
      updatedUser = recordUserInboundSyncRun(updatedUser, {
        ...
        providerCursor: surfaceInput.providerCursor,
        highWatermarkAt: surfaceInput.highWatermarkAt,
        highWatermarkId: surfaceInput.highWatermarkId,
        lastCompleteSnapshotId: surfaceInput.lastCompleteSnapshotId,
        nextAllowedSyncAt: surfaceInput.nextAllowedSyncAt,
        backoffReason: surfaceInput.backoffReason,
        syncTrustStatus: surfaceInput.syncTrustStatus,
