...
do:
  ...
  - Use recent activity only if it is actually engageable.
avoid:
  - Do not invent a warmup hook.
  - Do not jump straight to fallback-channel work unless the primary path is blocked.
writeback:
