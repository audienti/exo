...
do:
  ...
  - If the person is known and defensible already, seed them directly into the motion-owned target account so later cadence work has a governed object to act on.
avoid:
...
writeback:
  ...
  - After seeding, move the target forward through research, prospect selection, cadence, and touch writeback as normal.
---
